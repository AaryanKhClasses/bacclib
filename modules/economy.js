...
class economy {
    ...
    * @param {number} [coins] - Amount of Coins to add!
    */
    ...
    * @param {string} [userID] - ID of the discord user!
    * @param {string} [guildID] - ID of the discord guild!
    * @param {number} [coins] - Amount of Coins to set!
    */
    ...
    * @param {array} [leaderboard] - The output from 'fetchCoinsLeaderboard' function.
    */
